(function(window, document, ee) {
    ...
    Editor.prototype.execInsertImage = function (value) {
        exec('insertImage', false, value);
    };
    ...
    Editor.prototype.insertImage = command('InsertImage');
    ...
    Editor.prototype.reportInsertImage = report('insertImage', 'type');
